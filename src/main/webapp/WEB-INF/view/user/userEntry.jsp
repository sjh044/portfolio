...
<body>
<form:form modelAttribute="user" method="post" name="s"
                                        action="userEntry.do">
        ...
        <spring:message code="${error.code }"/>
					...
					<div class="xans-element- xans-member xans-member-join">
						...
						<div class="ec-base-joinus-table typeWrite">
							...
							<tr>
								...
								<td><form:input path="userid"
											...
											value="" type="text"/> 
									<span id="idMsg"></span> (영문소문자/숫자, 4~16자)<font color="red"><form:errors path="userid" /></font></td>
							</tr>
							<tr>
								<th scope="row">비밀번호 
								<img src="http://img.echosting.cafe24.com/skin/base/common/ico_required.gif"
									...
									<td><input type="password" name="password" id="pw" onchange="check_pw()">
											(영문대소문자/숫자/특수문자 중 2가지 이상 조합, 10자~16자)</td>
							</tr>
							<tr>
								<th scope="row">비밀번호 확인 
								<img src="http://img.echosting.cafe24.com/skin/base/common/ico_required.gif"
											alt="필수"></th>
										<td><input type="password" name="password2" id="pw2" onchange="check_pw()">&nbsp;<span id="check"></span></td>
									</tr> 
									...
									<tr>
										...
										<form:input path="name" type="text" maxlength="20"/></span> <span
											id="under14Msg" class="displaynone">14세 미만 사용자는 법정대리인
												동의가 필요합니다.</span><font color="red"><form:errors path="name" /></font></td>
									</tr>
									...
									<tr class="">
										...
										<td><select id="phone1" name="phone1"
											...
											fw-filter="isNumber" fw-label="휴대전화" fw-alone="N" fw-msg=""
											value="" type="text">-<input id="phone3"
											name="phone3" maxlength="4" fw-filter="isNumber"
										...
										<th scope="row">주소 <img
											...
											alt="필수"></th>
										<td><input id="uaddr1" name="uaddr1"
											...
											<input id="uaddr3" name="uaddr3" fw-filter=""
									...
									<tr class="displaynone">
										...
										<td><input id="is_sms0" name="is_sms" fw-filter=""
											fw-label="is_sms" fw-msg="" class="ec-base-chk" value="T"
											type="checkbox"><label for="is_sms0">동의함</label>
									...
									<tr>
										...
										<td><form:input path="email"
											...
											fw-msg="" value="" type="text"/> <span id="emailMsg"></span><font color="red"><form:errors path="email" /></font>
										</td>
									</tr>
						...
						<div class="ec-base-box typeThinBg gStrong">
							<p>
								<span class="ec-base-chk"><input id="sAgreeAllChecked"
									type="checkbox"><em class="checkbox"></em></span><label
									for="sAgreeAllChecked"><strong>이용약관 및 개인정보수집 및
										이용, 쇼핑정보 수신(선택)에 모두 동의합니다.</strong></label>
							</p>
						</div>
						<div class="ec-base-agree typeThinBg agreeArea">
							<h3>이용약관 동의</h3>
							<div class="content">
								<p>
									제1조(목적)<br>이 약관은 OO 회사(전자상거래 사업자)가 운영하는 OO 사이버 몰(이하 “몰”이라
								...
								<p>
									제2조(정의)<br>① “몰”이란 OO 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게
									제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며,
									아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.<br>② “이용자”란 “몰”에 접속하여 이
									약관에 따라 “몰”이 제공하는 서비스를 받는 회원 및 비회원을 말합니다.<br>③ ‘회원’이라 함은
									“몰”에 회원등록을 한 자로서, 계속적으로 “몰”이 제공하는 서비스를 이용할 수 있는 자를 말합니다.<br>④
								...
								<p>
									...
									및 정보보호 등에 관한 법률」 제25조 제1항에 의한 개인정보 처리위탁의 경우 등 관련 법령에 달리 정함이 있는
									경우에는 그에 따릅니다.
								</p>
								<p>
								...
								<p>
									...
									개인정보보호 책임자의 신원(소속, 성명 및 전화번호, 기타 연락처), 정보의 수집목적 및 이용목적, 제3자에 대한
									...
									보호를 위하여 이용자의 개인정보를 처리하는 자를 최소한으로 제한하여야 하며 신용카드, 은행계좌 등을 포함한
							...
							<p class="check">
								<span>이용약관에 동의하십니까?</span> <input id="agree_service_check0"
									...
									fw-msg="이용약관에 동의 하세요" class="ec-base-chk" value="1"
									type="checkbox"><label for="agree_service_check0">동의함</label>
							</p>
						</div>
						<div class="ec-base-agree typeThinBg agreeArea">
						...
						<div class="ec-base-button"
							style="clear: both; padding: 30px 0px 40px;">
							<a  href="javascript:s.submit();"style="border: 1px solid #cccccc; box-sizing: border-box;
    							font-size: 12px; width: 125px; display: inline-block; text-align: center; line-height: 38px;background: #333;
   										 color: #fff;">회원가입</a>
...
function execPostCode() {
    new daum.Postcode({
        oncomplete: function(data) {
           ...
           $("[name=uaddr1]").val(data.zonecode);
           $("[name=uaddr2]").val(fullRoadAddr);

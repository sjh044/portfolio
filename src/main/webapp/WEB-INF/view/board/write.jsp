		...
		<div id="container">
			<div id="contents">
				...
				<div
					...
					<form:form modelAttribute="board" action="write.do"
									...
									<tbody>
										...
										<tr>
											...
											<td><form:input path="name"
												fw-filter="isFill" fw-label="제목" fw-msg=""
												class="inputTypeText" placeholder="" maxlength="125"
												value="${loginUser.name}" readonly="true" type="text"/> <font color="red"><form:errors path="name" /></font></td>
